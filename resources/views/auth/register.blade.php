<x-layout>
  <div class="conteiner-fluid p-5 bg--info text-center text-white">
    ...
    <div class="col-12 col-md-8">
      ...
      <form class="card p-5 shadow" action="{{route('register')}}" method="post">
        ...
        <div class="mb-3">
          ...
          <input name="password_confirmation" type="password" class="form-control" id="password_confrimation">
        </div>
        <div class="mt-2">
